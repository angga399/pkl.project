...
<body class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-100 to-gray-300 py-10">
    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2 mt-6 max-w-4xl">
        <!-- Tombol Absen Datang -->
        <div id="absen-datang" class="p-8 bg-white rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-200">
        ...
        <!-- Tombol Absen Pulang -->
        <div id="absen-pulang" class="p-8 bg-white rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-200">
