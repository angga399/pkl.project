<head>
        ...
        <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-10 md:space-y-0 space-y-6">
          ...
          <div class="p-4 md:w-1/3 flex flex-col text-center items-center transition-transform transform hover:scale-105">
            ...
            <div class="flex-grow">
              ...
              <a class="mt-3 text-blue-400 inline-flex items-center hover:text-blue-600 transition-all duration-300 transition-page" href="{{ route('daftarhdr.index') }}">
                Go Page
                <i class="fas fa-arrow-right ml-2"></i>
              </a>
            </div>
          ...
          <div class="p-4 md:w-1/3 flex flex-col text-center items-center transition-transform transform hover:scale-105">
            ...
            <div class="flex-grow">
              ...
              <a class="mt-3 text-blue-400 inline-flex items-center hover:text-blue-600 transition-all duration-300 transition-page" href="{{ route('dftrshalats.index') }}">
                Go Page
                <i class="fas fa-arrow-right ml-2"></i>
              </a>
            </div>
  ...
  <script src="path/to/your/script.js"></script>
      ...
      // Pastikan halaman selesai dimuat sebelum menambahkan event listener
